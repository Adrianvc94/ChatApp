...
const Sidebar = ({ id, setIsLoggedIn }) => {
        ...
        <Tab.Container activeKey={activeKey} onSelect={setActiveKey}>
          ...
          >
            <Nav
              navbarScroll
              variant="tabs"
              className={`${Classes.sidebar_nav}`}
            >
              <Nav.Item
                className={`${Classes.sidebar_nav__item} ${
                  selected ? Classes.sidebar_nav__item_Active : ""
                }`}
                onClick={active}
              >
                <Nav.Link eventKey={CONVERSATIONS_KEY}>
                  <MdQuestionAnswer
                    className={`${Classes.sidebar_nav__contactImg} `}
                  />
                </Nav.Link>
              </Nav.Item>
              <Nav.Item
            ...
            <div className={`${Classes.button_container}`}>
              ...
              <Button
                ...
                className={`${Classes.button}`}
              >
                Exit <MdLogout className={`${Classes.btnlogoutImg}`}/>
